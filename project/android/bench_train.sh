...
function bench_android() {
    ...
    adb shell "LD_LIBRARY_PATH=$ANDROID_DIR $ANDROID_DIR/runTrainDemo.out MnistTrain mnist"
    ...
    # adb shell "LD_LIBRARY_PATH=$ANDROID_DIR $ANDROID_DIR/runTrainDemo.out ImageDatasetDemo $ANDROID_DIR/train_dataset/train_images $ANDROID_DIR/train_dataset/train.txt"
