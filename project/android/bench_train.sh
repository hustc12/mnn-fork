...
function bench_android() {
    ...
    adb shell "LD_LIBRARY_PATH=$ANDROID_DIR $ANDROID_DIR/runTrainDemo.out MnistTrain $ANDROID_DIR/dataset/train_images"
...
#     adb shell "LD_LIBRARY_PATH=$ANDROID_DIR $ANDROID_DIR/runTrainDemo.out MobilenetV2Train $ANDROID_DIR/dataset/train_images/ $ANDROID_DIR/dataset/train_images/train_label.txt $ANDROID_DIR/dataset/train_images/ $ANDROID_DIR/dataset/train_images/train_label.txt"
